...
class RNNSequenceModel(nn.Module):
    ...
    def forward(self, input, input_len):
        ...
        packed = pack_padded_sequence(input, input_len.cpu(), batch_first=True, enforce_sorted=False)
...
class BERTSequenceModel(nn.Module):
    ...
    def __init__(self, model_params):
        ...
        self.embed_dim = model_params['embed_dim']
        self.hidden_size = model_params['hidden_size']
        self.do_linear = model_params['linear']
        self.dropout_ratio = model_params.get('dropout_ratio', 0)
    ...
    def forward(self, input, input_len):
        ...
        output = self.bert(input, attention_mask=attention_mask)[0]
