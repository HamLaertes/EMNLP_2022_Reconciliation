...
if __name__ == '__main__':
    ...
    # Meta-training
    meta_learner.proto_analyzer(train_episodes, config['num_shots']['wsd'], 'train')
    logger.info('Meta-learning proto analyzer complete')

    # Meta-testing
    # meta_learner.proto_analyzer(test_episodes, config['num_shots']['wsd'], 'test')
    # logger.info('Meta-testing proto analyzer complete')
